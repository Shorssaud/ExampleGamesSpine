...
public class TankAIWhite: Tank
{
    ...
    private Material tankMaterial; // Reference to the tank's material
    ...
    IEnumerator FadeAndDisappear()
    {
        ...
        while (Time.time - startTime < fadeDuration)
        {
            ...
            // Set the tank's material alpha value
            Color tankColor = tankMaterial.color;
            tankMaterial.color = new Color(tankColor.r, tankColor.g, tankColor.b, alpha);
